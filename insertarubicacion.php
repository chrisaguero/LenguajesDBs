<?php 
    ...
    {
        $nombrubi = $_POST["txtlug"];

        $respuesta = InsertarUbicacion($nombrubi);

        if ($respuesta == null){
            echo '
                  <script>
                      alert("Ubicacion Registrada Correctamente. Refrescando Página.");
...
<head>
    <title>Insertar Ubicaciones</title>
    <meta charset="utf-8" />
        ...
        <header id="header">
            <nav id="nav">
                <ul>
                    ...
                    <li><a href="registroubicacion.php">Registro</a></li>
                </ul>
            </nav>
        </header>
                ...
                <!-- Content -->
                        ...
                        <form method="POST">
                            ...
                            <div class="row">
                                ...
                                <span class="input-group-text" id="basic-addon1">Nombre de Ubicación</span>
